...
public class BackP {
    ...
    double it=0;
    public BackP(int input_node, int hide1_node, int out_node, double rate) {
        super();
...
//        System.out.print("输出大小"+Data.length+" 隐藏大小 "+hide1_x.length );
    ...
    public void train(double[] TrainData, double[] target) {
        // 2.1导入训练数据集和目标值
//        System.out.println();
//        System.out.print("训练大小"+TrainData.length);
